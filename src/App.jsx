  ...
  if (error) {
    return (
      ...
      >
        ...
        <div
          className="card"
          style={{ maxWidth: "560px", textAlign: "center", padding: "1.5rem" }}
        >
          ...
          >
              ...
              <div className="card welcome-card">
                <div className="welcome-content">
                  <div className="welcome-text">
                    ...
                    <p>
                      Real-time biological intelligence powered by Python EDA
                      analysis. Dataset spans{" "}
                      <strong>
                        {summary.analysis_start?.substring(0, 10)}
                      </strong>{" "}
                      to{" "}
                      <strong>{summary.analysis_end?.substring(0, 10)}</strong>.
                      Select a module tab to drill into specific predictive
                      analytics.
                    </p>
                  </div>
            ...
            <div className="dashboard-grid">
              <div className="card highlight-gold">
                ...
                <div className="stat-footer">
                  Active colony clusters in dataset
                </div>
              </div>
              ...
              <div className="card highlight-cyan">
                ...
                <div className="stat-footer">
                  Sensor readings evaluated by EDA
                </div>
              </div>
              ...
              <div className="card highlight-crimson">
                ...
                <div className="stat-footer">
                  Swarm, absconding, or brood alerts
                </div>
              </div>
            </div>
            ...
            <div className="dashboard-grid">
              ...
              <div className="card highlight-crimson">
                ...
                <div className="stat-footer">
                  <span>
                    Min: {sensorStats.temperature?.min ?? "—"} | Max:{" "}
                    {sensorStats.temperature?.max ?? "—"}
                  </span>
                </div>
              </div>
              ...
              <div className="card highlight-cyan">
                ...
                <div className="stat-footer">
                  <span>
                    Range: {sensorStats.humidity?.min ?? "—"} –{" "}
                    {sensorStats.humidity?.max ?? "—"}%
                  </span>
                </div>
              </div>
              ...
              <div className="card highlight-gold">
                ...
                <div className="stat-footer">
                  <span>
                    Range: {sensorStats.weight?.min ?? "—"} –{" "}
                    {sensorStats.weight?.max ?? "—"} kg
                  </span>
                </div>
              </div>
              ...
              <div className="card highlight-emerald">
                ...
                <div className="stat-footer">
                  <span>
                    Range: {sensorStats.co2?.min ?? "—"} –{" "}
                    {sensorStats.co2?.max ?? "—"} ppm
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="dashboard-grid">
                ...
                <div className="recs-container" style={{ marginTop: "1rem" }}>
                  <div className="rec-item">
                    ...
                    <div className="rec-text">
                      <h4 style={{ color: "var(--accent-emerald)" }}>
                        1. Brood Health Status
                      </h4>
                      <p>
                        Evaluates thermal and humidity stability against
                  ...
                  <div className="rec-item">
                    ...
                    <div className="rec-text">
                      ...
                      <p>
                        Detects abrupt weight changes with CO2 and temperature
                        spikes.
                      </p>
                    </div>
                  </div>
                  <div className="rec-item">
                    ...
                    <div className="rec-text">
                      <h4 style={{ color: "var(--accent-gold)" }}>
                        3. Absconding Behavior
                      </h4>
                      <p>
                        Identifies slow-moving depopulation before full colony
                        loss.
                      </p>
                    </div>
                  </div>
                  <div className="rec-item">
                    ...
                    <div className="rec-text">
                      ...
                      <p>
                        Calculates weight plateaus to schedule maximum yield
                        extraction.
                      </p>
                    </div>
                  </div>
              ...
              <div className="card highlight-crimson">
                ...
                >
                  {[
                    {
                      label: "Temp Anomalies (|dev| > 1°C)",
                      value: anomalies.temperature_anomalies ?? "—",
                    },
                    {
                      label: "Weight Drops (< -0.5 kg)",
                      value: anomalies.weight_drops ?? "—",
                    },
                    {
                      label: "CO2 Spikes (> 1800 ppm)",
                      value: anomalies.co2_spikes ?? "—",
                    },
                  ].map(({ label, value }) => (
                    <div
                      key={label}
            ...
            {totalActiveAlerts > 0 && (
              <div className="alert-banner">
                ...
                <div>
                  <strong>Apiary Alert Summary:</strong> Python EDA detected{" "}
                  {anomalies.co2_spikes} CO2 spikes, {anomalies.weight_drops}{" "}
                  weight drops, and{" "}
                  {
                    broodPerHive.filter((h) => h.status === "Needs Attention")
                      .length
                  }{" "}
                  hive(s) with poor brood climate control. Open individual tabs
