    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div className="card" style={{ padding: '0.5rem', display: 'flex', gap: '0.5rem', background: 'rgba(0,0,0,0.2)' }}>
        <button
          ...
          className={`tab-btn ${activeTab === 'hive' ? 'active' : ''}`}
          style={{ 
            flex: 1, 
            padding: '0.75rem', 
            background: activeTab === 'hive' ? 'var(--accent-emerald)' : 'transparent', 
            color: activeTab === 'hive' ? '#0f172a' : 'var(--text-secondary)', 
            border: 'none', 
            borderRadius: '8px', 
            cursor: 'pointer', 
            display: 'flex', 
        ...
        >
          <Home size={18} /> Exploratory Analysis
        </button>
        <button
          ...
          style={{ 
            flex: 1, 
            padding: '0.75rem', 
            background: activeTab === 'brood' ? 'var(--accent-gold)' : 'transparent', 
            color: activeTab === 'brood' ? '#0f172a' : 'var(--text-secondary)', 
            border: 'none', 
            borderRadius: '8px', 
            cursor: 'pointer', 
            display: 'flex', 
        ...
        >
          <Activity size={18} /> Model Training
        </button>
        <button
          ...
          style={{ 
            flex: 1, 
            padding: '0.75rem', 
            background: activeTab === 'swarm' ? 'var(--accent-crimson)' : 'transparent', 
        ...
        >
          <Zap size={18} /> Live Prediction
        </button>
      </div>

      {/* Tab Content */}
      {activeTab === 'hive' && <SwarmExploratory />}
      {activeTab === 'brood' && <SwarmTraining />}
      {activeTab === 'swarm' && <SwarmPrediction />}
